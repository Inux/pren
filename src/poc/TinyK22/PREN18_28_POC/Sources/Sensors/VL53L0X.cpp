...
//  last_status = Wire.endTransmission();
  ...
  last_status = i2cWriteCmdData(address, reg, buf, sizeof(buf));
}
...
//  value = Wire.read();
  ...
  last_status = i2cReadCmdData(address, reg, &value, sizeof(value));
...
//  value |=           Wire.read();      // value low byte
  ...
  last_status = i2cReadCmdData(address, reg, (uint8_t*)&value, sizeof(value));
...
//  last_status = Wire.endTransmission();
  ...
  last_status = i2cWriteCmdData(address, reg, src, count);
...
//  }
  ...
  last_status = i2cReadCmdData(address, reg, dst, count);
}
