...
{
  if ((FTM3_C0SC & CHF_CHIE_MASK) == CHF_CHIE_MASK)
    FTM3CH0_IRQHandler();
  if ((FTM3_C1SC & CHF_CHIE_MASK) == CHF_CHIE_MASK)
    FTM3CH1_IRQHandler();
  if ((FTM3_C2SC & CHF_CHIE_MASK) == CHF_CHIE_MASK)
    FTM3CH2_IRQHandler();
  if ((FTM3_C3SC & CHF_CHIE_MASK) == CHF_CHIE_MASK)
    FTM3CH3_IRQHandler();
  if ((FTM3_C4SC & CHF_CHIE_MASK) == CHF_CHIE_MASK)
    FTM3CH4_IRQHandler();
  if ((FTM3_C5SC & CHF_CHIE_MASK) == CHF_CHIE_MASK)
    FTM3CH5_IRQHandler();
  if ((FTM3_C6SC & CHF_CHIE_MASK) == CHF_CHIE_MASK)
    FTM3CH6_IRQHandler();
  if ((FTM3_C7SC & CHF_CHIE_MASK) == CHF_CHIE_MASK)
    FTM3CH7_IRQHandler();
  if ((FTM3_SC & TOF_TOIE_MASK) == TOF_TOIE_MASK)
    FTM3TOF_IRQHandler();
}
