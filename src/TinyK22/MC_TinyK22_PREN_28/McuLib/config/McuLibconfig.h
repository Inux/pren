...
#define McuLib_CONFIG_CPU_IS_KINETIS         (1) /*(1 && McuLib_CONFIG_CPU_IS_ARM_CORTEX_M)*/
...
#define McuLib_CONFIG_FPU_PRESENT   (1) /*(1 || (defined(__FPU_PRESENT) && (__FPU_PRESENT)==1))*/
  /*!< 1: floating point unit present, 0: otherwise */
#define McuLib_CONFIG_FPU_USED      (1) /*(1 || (defined(__FPU_USED) && (__FPU_USED)==1))*/
...
#define McuLib_CONFIG_SDK_S32K                5
  ...
  #define McuLib_CONFIG_SDK_VERSION        (250) /*(McuLib_CONFIG_SDK_VERSION_MAJOR*100)+(McuLib_CONFIG_SDK_VERSION_MINOR*10)+McuLib_CONFIG_SDK_VERSION_BUILD*/
...
#else
  #define McuLib_CONFIG_SDK_VERSION_USED  McuLib_CONFIG_SDK_MCUXPRESSO_2_0 /*McuLib_CONFIG_SDK_PROCESSOR_EXPERT */
...
/* Configuration macro if FreeRTOS is used */
  ...
  #define McuLib_CONFIG_SDK_USE_FREERTOS          (0) /*(1)*/
