/**
 * From: https://github.com/pololu/vl53l1x-arduino
 * Adapted for TinyK22
 */
...
uint8_t VL53L0X_getAddress(void) { return VL53L0X_address; }
...
#define startTimeout() (VL53L0X_timeout_start_ms = millis())

// Check if timeout is enabled (set to nonzero value) and has expired
#define checkTimeoutExpired() (VL53L0X_io_timeout > 0 && ((uint16_t)millis() - VL53L0X_timeout_start_ms) > VL53L0X_io_timeout)
...
void VL53L0X_Constructor(void)
{
  ...
  VL53L0X_io_timeout = (0); // no timeout
...
bool VL53L0X_init(bool io_2v8)
{
  ...
  VL53L0X_stop_variable = VL53L0X_readReg(0x91);
...
//  last_status = Wire.endTransmission();
  ...
  VL53L0X_last_status = i2cWriteCmdData(VL53L0X_address, reg, buf, sizeof(buf));
}
...
//  last_status = Wire.endTransmission();
  ...
  uint8_t buf[] = {
     (uint8_t)((value >> 8) & 0xFF), // value high byte
...
//  last_status = Wire.endTransmission();
  ...
  uint8_t buf[] = {
      (uint8_t)((value >> 24) & 0xFF), // value highest byte
      (uint8_t)((value >> 16) & 0xFF),
      (uint8_t)((value >>  8) & 0xFF),
      (uint8_t)( value        & 0xFF), // value lowest byte
  };
...
//  value = Wire.read();
  ...
  VL53L0X_last_status = i2cReadCmdData(VL53L0X_address, reg, &value, sizeof(value));
...
//  last_status = Wire.endTransmission();
//
//  Wire.requestFrom(VL53L0X_address, (uint8_t)2);
//  value  = (uint16_t)Wire.read() << 8; // value high byte
//  value |=           Wire.read();      // value low byte

  VL53L0X_last_status = i2cReadCmdData(VL53L0X_address, reg, (uint8_t*)&value, sizeof(value));
...
//  last_status = Wire.endTransmission();
//
//  Wire.requestFrom(VL53L0X_address, (uint8_t)4);
...
//  last_status = Wire.endTransmission();
  ...
  VL53L0X_last_status = i2cWriteCmdData(VL53L0X_address, reg, src, count);
...
//  }
  ...
  VL53L0X_last_status = i2cReadCmdData(VL53L0X_address, reg, dst, count);
}
...
void VL53L0X_startContinuous(uint32_t period_ms)
{
  ...
  VL53L0X_writeReg(0xFF, 0x01);
  VL53L0X_writeReg(0x00, 0x00);
  VL53L0X_writeReg(0x91, VL53L0X_stop_variable);
  VL53L0X_writeReg(0x00, 0x01);
  VL53L0X_writeReg(0xFF, 0x00);
  VL53L0X_writeReg(0x80, 0x00);
