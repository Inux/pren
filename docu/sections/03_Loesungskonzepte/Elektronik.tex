\documentclass[../../main.tex]{subfiles}
    ...
    Die Antriebsenergie wird direkt von den Schienen bezogen und lediglich auf die korrekte Motorspannung angepasst. Die
    ...
    Das StormPi Modul wird mit einem LiFePO4-Akku ergänzt. Der stadart Akku hat $1000mAh$. Bei einer Spannung von $3.7V$ entspricht dies $3.7Wh$. \\
