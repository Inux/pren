...
\begin{document}
    ...
    Der Ladungsträger ist das Verbindungselement von Antriebswagen und Führungswagen. Er wird an beiden Enden drehbar mit je einem Radiallager gelagert. Die Flächen der Platten reiben auf den beiden Wagen. Durch eine optimale Materialparung wird diese Reibkraft jedoch vernachlässigbar klein. Der Träger besteht aus den drei Teilen mit Position 1,3 und 7 (siehe Abbidlung \ref{fig:expl_ladungstraeger}), welche durch Zylinderschrauben (Position 5) und einer Zwischenplatte (Position 2) zusammengebaut wird. Der Hauptgrund ist die einfachere, materialsparende sowie kostengünstigere Herstellung.\\
