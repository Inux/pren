...
\begin{document}
    ...
    \begin{figure}[H] %Lokomotive mit Positionsnummern
        \centering
        \includegraphics[width=0.8\textwidth]{Lokomotive.png}
    ...
    \begin{table}[H] \centering
        ...
        Position 2          & Achsen mit Gewinden an beiden Enden und Anfräsfläche für Gabelschlüssel\\
         \hline
        Position 3          & Rillenkugellager (Loslager)\\
        \hline
        Position 4          & Eingepresstes Rillenkugellager (Festlager)\\
        \hline       
        Position 5          & Sicherungsring für Rillenkugellager\\
        \hline
        Position 6          & Rad\\
        \hline
        Position 7         & Unterlagscheibe\\
        \hline
        Position 8         & Zylinderschraube\\
        \hline
        \end{tabular}
    ...
    \begin{table}[H] \centering
        ...
        Position 1          & Motor\\
         \hline
        Position 2          & Spannsatz\\
        \hline
        Position 3          & Zahnriemenrad\\
        \hline
        Position 4          & Rillenkugellager (Loslager)\\
        \hline
        Position 5          & Rillenkugellager (Feslager)\\
        \hline
        Position 6          & Sicherungsring\\
        \hline
        Position 7          & Sicherungsplatte\\
        \hline
        Position 8          & Zahnräder 1:2 Übersetzung\\
        \hline
        Position 9          & Zahnriemen\\
        \hline
        Position 10         & Gewindestifte für das Einstellen der Riemenspannung\\
        \hline
        Position 11         & Zylinderschrauben für Befestigung von Grundgestell\\
        \hline
        Position 12         & Zylinderschrauben für Befestigung von Sicherungsplate\\
        \hline
        Position 13         & Grundgestell\\
        \hline
        Position 14         & Drehachse\\
        \hline
        \end{tabular}
    ...
    a\textsubscript{max}=\(\frac{F\textsubscript{Reibung}}{\frac{F\textsubscript{Rad}}{g}}\)=\(\frac{0.375Nm}{1}\)\\
    ...
    \begin{figure}[H] %Bild von Zug (Ansicht von vorne) mit Schwerpunkt und Positionsnummern
        \centering
        \includegraphics[width=0.9\textwidth]{Fuehrungswagen.png}
        \caption{Schwerpunkt des Zuges in der Seitenansicht}
        \label{fig:schwerpunktn}
    \end{figure}
    ...
    \textbf{Statische Auslegung}\\    
    Die Lagerkräfte (siehe Abbildung \ref{fig:lagerkraefte_ladungstraeger}) in den beiden Wägen werden durch Statikberechnungen festgelgt. Mit den Berechneten Werten werden die Wälzlager definiert.\\

    \begin{figure}[H] %Kräfte im System
        \centering
        \includegraphics[width=0.9\textwidth]{Fuehrungswagen.png}
        \caption{Explosionsdarstellung Ladungsträger}
        \label{fig:lagerkraefte_ladungstraeger}
    \end{figure} 
