\documentclass[../../main.tex]{subfiles}
    ...
    \begin{figure}[H] %Nutzwertanalyse Kurvenfahrt
        \centering
        \includegraphics[width=1\textwidth]{Kurvenfahrt.png}
    ...
    \begin{figure}[H] %Nutzwertanalyse Bremsen
        \centering
        \includegraphics[width=1\textwidth]{Bremsen.jpg}
...
\end{flushleft}
  ...
  \begin{figure}[H] %Nutzwertanalyse Dämpfung
    \centering
    \includegraphics[width=1\textwidth]{Dämpfung.jpg}
...
\subsubsection{Greifen}
 ...
 \begin{figure}[H] %Nutzwertanalyse Greifen
    \centering
    \includegraphics[width=1\textwidth]{Greifen.jpg}
...
\begin{figure}[H] %Nutzwertanalyse Verschieben
    \centering
    \includegraphics[width=1\textwidth]{Verschieben_platzieren.jpg}
...
\begin{figure}[H] %Nutzwertanalyse Antrieb
    \centering
    \includegraphics[width=1\textwidth]{Antriebsstrang.jpg}
