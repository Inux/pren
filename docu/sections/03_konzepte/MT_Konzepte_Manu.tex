\documentclass[../../main.tex]{subfiles}
    ...
    \graphicspath{{images/}{../../images/Maschinentechnik/}}
    ...
    %    \centering
    %    \includegraphics[width=1\textwidth]{Schwenker}
    ...
    %\begin{figure}[H] % Skizze Tiefer Schwerpunkt
    %    \centering
    %    \includegraphics[width=1\textwidth]{Tieferschwerpunkt}
    %    \caption{Lösungskonzept Tiefer Schwerpunkt}
    %    \label{fig:tieferschwerpunkt}
    %\end{figure}
...
\end{figure}
  ...
  %\begin{figure}[H] %Skizze Stossdaempfer
  %  \centering
  %  \includegraphics[width=1\textwidth]{Stossdaempfer}
...
\end{figure}
 ...
 %   \centering
 %   \includegraphics[width=1\textwidth]{Stab}
...
\textbf{Magnet}\\
 ...
 %\begin{figure}[H] %Skizze Magnet
 %   \centering
 %   \includegraphics[width=1\textwidth]{Magnet}
 %   \caption{Lösungskonzept Magnet}
 %   \label{fig:magnet}
%\end{figure}
